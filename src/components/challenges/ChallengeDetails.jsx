...
const ChallengeDetails = ({ challenge, onClose }) => {
  ...
  const tasks = getTasks(challenge.id);
    ...
    <div className="space-y-6">
      <div className="bg-gray-50 p-4 rounded-lg space-y-4">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div>
            <h3 className="text-sm font-medium text-gray-500">Challenge Title</h3>
            <p className="mt-1 text-sm text-gray-900">{challenge.title}</p>
          </div>
          <div>
            <h3 className="text-sm font-medium text-gray-500">End Time</h3>
            <p className="mt-1 text-sm text-gray-900">{formatDate(challenge.endTime)}</p>
          </div>
          <div>
            <h3 className="text-sm font-medium text-gray-500">Required Points</h3>
            <p className="mt-1 text-sm text-gray-900">{challenge.subscriptionPoints}</p>
          </div>
        </div>
        
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div>
            <h3 className="text-sm font-medium text-gray-500">Reward per Correct Answer</h3>
            <p className="mt-1 text-sm text-gray-900">+{challenge.rewardPoints} points</p>
          </div>
          <div>
            <h3 className="text-sm font-medium text-gray-500">Deduction per Wrong Answer</h3>
            <p className="mt-1 text-sm text-gray-900">-{challenge.deductionPoints} points</p>
          </div>
          <div>
            <h3 className="text-sm font-medium text-gray-500">Number of Tasks</h3>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div>
            <h3 className="text-sm font-medium text-gray-500">1st Place Reward</h3>
            <p className="mt-1 text-sm text-gray-900">{challenge.rewards.first} points</p>
          </div>
          <div>
            <h3 className="text-sm font-medium text-gray-500">2nd Place Reward</h3>
            <p className="mt-1 text-sm text-gray-900">{challenge.rewards.second} points</p>
          </div>
          <div>
            <h3 className="text-sm font-medium text-gray-500">3rd Place Reward</h3>
            <p className="mt-1 text-sm text-gray-900">{challenge.rewards.third} points</p>
          </div>
        </div>
      </div>
