...
const TaskQuestions = ({ challengeId, task, onClose }) => {
  ...
  const questions = getTaskQuestions(challengeId, task.id);
  ...
  const confirmDeleteQuestion = () => {
    if (questionToDelete) {
      deleteTaskQuestion(challengeId, task.id, questionToDelete.id);
    ...
    <div className="space-y-6">
      <div className="bg-gray-50 p-4 rounded-lg">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div>
            <h3 className="text-sm font-medium text-gray-500">Questions Count</h3>
